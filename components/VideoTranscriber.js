      ...
      <div style={{ flex: 1, maxWidth: 720, width: "100%", margin: "0 auto", padding: "24px 16px 40px", boxSizing: "border-box" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 16px 16px" }}>
            <span style={{ fontSize: 12, color: "#4a4540" }}>
              Sermons, teachings, any video with captions
            </span>
        ...
        {loading && (
          <div style={{ textAlign: "center", padding: "48px 0" }}>
            ...
            <p style={{ color: "#7a7060", fontSize: 15 }}>Fetching the transcript…</p>
          </div>
        )}
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 8, marginBottom: 6 }}>
                ...
                {result.autoGenerated && (
                  <span style={{ padding: "3px 10px", borderRadius: 100, background: "#78350f55", color: "#fcd34d", fontSize: 11, fontWeight: 600, whiteSpace: "nowrap" }}>
        ...
        {!result && !loading && !error && (
          <div style={{ textAlign: "center", padding: "40px 20px", color: "#4a4540" }}>
            ...
            <p style={{ fontSize: 15, lineHeight: 1.7, maxWidth: 420, margin: "0 auto" }}>
              Paste a YouTube link above and tap <strong style={{ color: "#d4af37" }}>Transcribe</strong> to
              turn the entire video into text you can read, copy, or download.
            </p>
            <p style={{ fontSize: 12, marginTop: 16, color: "#3a3530" }}>
              Works with any YouTube video that has captions — including auto-generated ones.
            </p>
          </div>
        )}
